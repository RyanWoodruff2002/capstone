    ...
    return (
      <div className="container mx-auto p-4 bg-white">
        <div className="w-full md:w-1/2 lg:w-1/3 mx-auto my-12">
          ...
          <form className="flex flex-col mt-4" onSubmit={handleLoginSubmit}>
            ...
            <input
                ...
                onChange={handleLoginChange}
            />
            <button className="mt-4 px-4 py-3  leading-6 text-base rounded-md border border-transparent text-white focus:outline-none bg-blue-500 text-blue-100 hover:text-white focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer inline-flex items-center w-full justify-center items-center font-medium focus:outline-none" type="submit">
              Submit
            </button>
          </form>
          <p className="mt-3 text-lg text-center ..." >or</p>
